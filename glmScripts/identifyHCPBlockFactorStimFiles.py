...
# Script to generate EVs for each HCP run; single regressor for each condition (basic block factor style)

import numpy as np


inputdir = '/projects3/ExternalDatasets2/HCPData2/HCPS1200MSMAll/'
outputdir = '/projects3/TaskFCMech/data/timingfiles3/'
TRLength = .720
...
taskOrder = ['EMOTION', 'GAMBLING', 'LANGUAGE', 'MOTOR', 'RELATIONAL', 'SOCIAL', 'WM']
...
for subj in subjNums:
    ...
    for task in taskOrder:
        ...
        for cond in tasks[task]:
            ...
            # Save file
            outfile = outputdir+subj+'_stimfile_HCPBasicBlockFactor_EV' + str(condcount) + '_' + task + '_' +  cond + '.1D'
            np.savetxt(outfile,stimArr,delimiter='\n')
